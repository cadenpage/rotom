...
class PacketHandler(Protocol):
    ...
    def ping(self, port, id) -> tuple[int, int, int]: ...
    ...
    def read1ByteTxRx(self, port, id, address) -> tuple[int, int, int]: ...
    def read2ByteTx(self, port, id, address): ...
    def read2ByteRx(self, port, id): ...
    def read2ByteTxRx(self, port, id, address) -> tuple[int, int, int]: ...
    def read4ByteTx(self, port, id, address): ...
    def read4ByteRx(self, port, id): ...
    def read4ByteTxRx(self, port, id, address) -> tuple[int, int, int]: ...
    def writeTxOnly(self, port, id, address, length, data): ...
    def writeTxRx(self, port, id, address, length, data) -> tuple[int, int]: ...
...
class GroupSyncRead(Protocol):
    ...
    def getData(self, id, address, data_length) -> int: ...
